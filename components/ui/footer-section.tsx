...
const footerLinks: FooterSection[] = [
  {
    ...
    links: [
      ...
      { title: "Freelancers", href: "/dashboard/freelancers" },
    ],
  },
  {
    label: "Company",
    links: [
      ...
      { title: "Open Bounty", href: "/dashboard/bounties" },
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Milestone Planning", href: "/dashboard/bounties" },
      { title: "Freelancer Fit", href: "/dashboard/freelancers" },
      ...
      <div className="grid w-full gap-8 xl:grid-cols-3 xl:gap-8">
        <AnimatedContainer className="space-y-4 text-slate-200">
          ...
          <p className="text-slate-400 mt-8 text-sm md:mt-0">
            Copyright {new Date().getFullYear()} BountyEscrow AI. All rights reserved.
          </p>
        </AnimatedContainer>
